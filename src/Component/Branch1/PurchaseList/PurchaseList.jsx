...
const PurchaseList = () => {
  ...
  const fetchPurchases = async () => {
    try {
      const response = await axios.get('https://i-server-eight.vercel.app/wala/shala/purchases');
  ...
  const fetchPurchaseById = async (id) => {
    try {
      const response = await axios.get(`https://i-server-eight.vercel.app/wala/shala/purchases/${id}`);
