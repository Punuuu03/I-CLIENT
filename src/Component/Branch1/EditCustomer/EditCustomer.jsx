...
const EditCustomer = () => {
    ...
    useEffect(() => {
        const fetchCustomer = async () => {
            try {
                const response = await axios.get(`https://i-server-eight.vercel.app/branch1/customers/${customer_id}`);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.put(`https://i-server-eight.vercel.app/branch1/customers/${customer_id}`, updatedCustomer);
            if (response.data.Status) {
