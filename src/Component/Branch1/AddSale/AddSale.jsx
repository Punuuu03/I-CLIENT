...
const AddSale = () => {
  ...
  useEffect(() => {
    // Fetch customers
    axios.get('https://i-server-eight.vercel.app/shala/customers')
      .then(response => {
    ...
    // Fetch products
    axios.get('https://i-server-eight.vercel.app/shala/products')
      .then(response => {
  ...
  const handleCustomerChange = async (event) => {
    ...
    setCustomerId(id);
    try {
      const response = await axios.get(`https://i-server-eight.vercel.app/shala/customers/${id}`);
  ...
  const handleProductChange = async (index, event) => {
    ...
    try {
      const response = await axios.get(`https://i-server-eight.vercel.app/shala/products/${id}`);
  ...
  const handleSubmit = (event) => {
    ...
    axios.post('https://i-server-eight.vercel.app/shala/sales', {
