...
const SaleDetails = () => {
  ...
  useEffect(() => {
    const fetchSaleDetails = async () => {
      try {
        const response = await axios.get(`https://i-server-eight.vercel.app/wala/shala/sale-details/${id}`);
        ...
        const customerResponse = await axios.get(`https://i-server-eight.vercel.app/shala/customers/${saleData.customer_id}`);
        setCustomerDetails({
