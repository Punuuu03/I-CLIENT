...
const AddCustomer = () => {
  ...
  const [leftEyeAddition, setLeftEyeAddition] = useState("0");
  const [rightEyeAddition, setRightEyeAddition] = useState("0");
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://i-server-eight.vercel.app/branch1/customers", newCustomer)
      .then((result) => {
              ...
              <div className="customer-form-row">
                ...
                <div className="customer-form-group">
                  ...
                  <input
                    ...
                    value={leftEyeDV.vn}
                    onChange={(e) =>
                      setLeftEyeDV({ ...leftEyeDV, vn: e.target.value })
                    }
                    required
                  />
                </div>
              ...
              <div className="customer-form-row">
                ...
                <div className="customer-form-group">
                  ...
                  <input
                    ...
                    value={leftEyeNV.vn}
                    onChange={(e) =>
                      setLeftEyeNV({ ...leftEyeNV, vn: e.target.value })
                    }
                    required
                  />
                </div>
              ...
              <div className="customer-form-row">
                ...
                <div className="customer-form-group">
                  ...
                  <input
                    ...
                    value={rightEyeDV.vn}
                    onChange={(e) =>
                      setRightEyeDV({ ...rightEyeDV, vn: e.target.value })
                    }
                    required
                  />
                </div>
              ...
              <div className="customer-form-row">
                ...
                <div className="customer-form-group">
                  ...
                  <input
                    ...
                    value={rightEyeNV.vn}
                    onChange={(e) =>
                      setRightEyeNV({ ...rightEyeNV, vn: e.target.value })
                    }
                    required
                  />
                </div>
