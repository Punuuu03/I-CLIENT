...
const AddPurchase = () => {
  ...
  useEffect(() => {
    axios.get('https://i-server-eight.vercel.app/follow/suppliers')
      .then(response => {
    ...
    axios.get('https://i-server-eight.vercel.app/follow/products')
      .then(response => {
  ...
  const handleSupplierChange = async (event) => {
    ...
    setSupplierId(id);
    try {
      const response = await axios.get(`https://i-server-eight.vercel.app/follow/suppliers/${id}`);
  ...
  const handleProductChange = async (index, event) => {
    ...
    try {
      const response = await axios.get(`https://i-server-eight.vercel.app/follow/products/${id}`);
  ...
  const handleSubmit = (event) => {
    ...
    axios.post('https://i-server-eight.vercel.app/follow/purchases', {
